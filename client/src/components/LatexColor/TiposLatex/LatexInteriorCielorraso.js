...
const LatexInteriorCielorraso = () => {
  ...
  const latexColor = allProductos.filter(e => e.seccion === "Látex Interior Cielorraso").slice(
    indexProductFirst,
    indexProductLast
  );
  ...
  return (
    <div>
      <Helmet>
        <title>Pintura Látex - Interior Cielorraso | Standar Aridos</title>
...
export default LatexInteriorCielorraso