...
const LatexInteriorLavable = () => {
  ...
  const latexColor = allProductos.filter(e => e.seccion === "Látex Interior Lavable").slice(
    indexProductFirst,
    indexProductLast
  );
  ...
  return (
    <div>
      <Helmet>
        <title>Pintura Látex - Interior Lavable | Standar Aridos</title>
...
export default LatexInteriorLavable