...
const LatexInterior = () => {
  ...
  const latexColor = allProductos.filter(e => e.seccion === "Látex Interior").slice(
    indexProductFirst,
    indexProductLast
  );
  ...
  return (
    <div>
      <Helmet>
        <title>Pintura Látex - Interior | Standar Aridos</title>
      ...
      <div className={s.layout}>
        <div className={s.titulo}>
          <h1>Látex Interior</h1>
        </div>
        <div className={s.bannerLatex}>
          {/* <img src={bannerLatex} alt="banner-latex" /> */}
          <div className={s.bannerFondoLatexInterior}></div>
        </div>
