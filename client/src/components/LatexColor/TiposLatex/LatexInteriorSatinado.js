...
const LatexInteriorSatinado = () => {
  ...
  const latexColor = allProductos.filter(e => e.seccion === "Látex Interior Satinado").slice(
    indexProductFirst,
    indexProductLast
  );
  ...
  return (
    <div>
      <Helmet>
        <title>Pintura Látex - Interior Satinado | Standar Aridos</title>
...
export default LatexInteriorSatinado